...
::: {.notes}
contributions e.g., what makes successful teaching?
:::
...
::: {.notes}
Against this background, the promotion of video data sharing is particularly justified
:::
...
- Shows typical work steps of provision and subsequent use
- Deliberately skips unspecific work steps (e.g. data analysis)
